...
| :--: | :--: | :--: | :--: | :--: | :--: | :--: |
| <img alt="정호재" src="이미지" height="100" width="80"> | <img alt="최진영" src="이미지" height="100" width="80"> | <img alt="양선우" src="이미지" height="100" width="80"> | <img alt="문지영" src="이미지" height="100" width="80"> | <img alt="임시은" src="이미지" height="100" width="80"> | <img alt="임태균" src="이미지" height="100" width="80"> | <img alt="고유강" src="이미지" height="100" width="80"> 
|- "" </br> - "" </br> - "" </br> - "" </br> - "" </br>| - 회원가입 </br> - OAUTH2.0(네이버,카카오,구글) </br> - 로그인(JWT) </br> - 마이페이지(member CRUD) </br> - GPT API연동 </br> - 리뷰(CRUD , s3 버킷 연동 이미지 업로드) , 찜하기 , 아이템(R)</br> - "" </br> - "" </br>|-  "" </br> - "" </br> - "" </br> - "" </br> - ""| - "" </br> - "" </br> - "" </br>- "" </br> |- "" </br> - "" </br> - "" </br> - "" </br> - "" </br> - "" </br> | - "" </br> - "" </br> - "" </br> - "" </br> - "" </br> - "" </br> | - 매장(CRUD) </br> - 주문 정보 관리(CRD) </br> - 결제 연동(Tosspayments) </br>
